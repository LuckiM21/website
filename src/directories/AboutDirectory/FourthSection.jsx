        ...
        <div className="grid svelte-885gk8">
          <div className="item svelte-885gk8">
            <p className="svelte-c4ft01">
              ...
              developing, I was Front desk data analyst. One of my earliest jobs
              involved emails, in a time before email linters. Lots of wishing,
            ...
            <p className="svelte-c4ft01">
              Outside coding, web designing, I am a geek that likes learning new
              things that excites me all the time, listening to music, exploring
              the world with my partner, and playing with my dog Sportty.
            </p>
          </div>
        </div>
      </div >
