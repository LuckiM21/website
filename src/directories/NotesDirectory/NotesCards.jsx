        ...
        <div className="showcase-holder svelte-88yij0">
          <div className="showcase svelte-88yij0">
              ...
              <div className="showcase-inner svelte-88yij0">
                <div className="deets svelte-88yij0">
                  ...
                  <span className="description svelte-88yij0">
                    Not all work needs to lead somewhere.
                  </span>
                </div>
            ...
            >
              <div className="showcase-inner svelte-88yij0">
                <div className="deets svelte-88yij0">
                  ...
                  <span className="description svelte-88yij0">
                    AI is here to eat all the things. Here`s how I use it to my
                    advantage.
                  </span>
                </div>
                <div className="showcase-icon svelte-88yij0">
            ...
            >
              <div className="showcase-inner svelte-88yij0">
                <div className="deets svelte-88yij0">
                  <div className="title svelte-88yij0">Architecture</div>
                  <span className="description svelte-88yij0">
                    I`m reworking my Cover Status plugin for Figma, here`s a
                    sneak peak.
                  </span>
                </div>
                <div className="showcase-icon svelte-88yij0">
