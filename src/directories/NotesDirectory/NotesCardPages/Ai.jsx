            ...
            <article className="svelte-9xj1dk">
              ...
              <figure className="video svelte-1q0lkgh shadow">
                <video
                  ...
                  loop=""
                  preload="auto"
                  poster="notes/how-i-code-with-ai"
                  className="svelte-1q0lkgh"
                >
                  <source src="notes/chatgpt/plugin.mp4" type="video/mp4" />
                </video>
              </figure>
              <p>
              ...
              <figure className="video svelte-1q0lkgh shadow">
                <video
                  ...
                  className="svelte-1q0lkgh"
                >
                  <source src="notes/chatgpt/figma-rest.mp4" type="video/mp4" />
                </video>
              </figure>
              <p>
              ...
              >
                <figure className="svelte-cmqfoo">
                  <img
                    src="notes/chatgpt/principles.png"
            ...
            <div className="newsletter svelte-9xj1dk">
              <div className="newsletter-content svelte-9xj1dk">
                ...
                <div className="newsletter-buttons svelte-9xj1dk">
                  ...
                  <a
                    href="https://twitter.com/share?url=https%3A%2F%2Fhalpin.xyz.com%2Fnotes%2Fhow-i-code-with-ai"
                    className="newsletter-link svelte-9xj1dk"
                  ...
                  <a
                    href="https://www.linkedin.com/shareArticle?mini=true&amp;url=https%3A%2F%2Fhalpin.xyz.com%2Fnotes%2Fhow-i-code-with-ai"
                    className="newsletter-link svelte-9xj1dk"
                    target="_blank"
