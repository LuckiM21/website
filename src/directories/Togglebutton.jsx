...
const Togglebutton = () => {
  ...
  function darkThemeToggle() {
    document.getElementById("themeChange").className = "dark";
  }
  function lightThemeToggle() {
    document.getElementById("themeChange").className = "light";
  }

  const toggleTheme = (e) => {
    if (e.target.checked) darkThemeToggle();
    else lightThemeToggle()
  }
