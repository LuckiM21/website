import hero from "../../../assets/images/ArtProjects/luckiearts1.jpg"
          ...
          <div className="article-inner svelte-9xj1dk">
            <div className="article svelte-9xj1dk">
              ...
              <article className="svelte-9xj1dk">
                ...
                >
                  <figure className="svelte-cmqfoo">
                    <img
                      ...
                      src={hero}
                      alt="Abstract image dipicting one of the artworks I drew"
                      width="100%"
                      height="auto"
                      loading="lazy"
                ...
                <h2>How I got into arts</h2>
                <p>
                  I descoverd my passion for art at a young age and began honing
                  my skills using whatever materials i could find.
                </p>
                <p>
                  I decided to use the ballpoint pen as medium because I see it as a versatile art medium, easy to
                  access and cheap compared to other mediums.
                </p>
                <p>
                  It suits the type of filling technique I use, which is
                  the cross-hatching technique, and it` s because it has to
                  with the fact that it` s non-erasable. The medium is not without
                  limitations; color availability and sensitivity of ink to light are among
                  my concerns.
                </p>
              ...
              <div className="container">
                <div style={{
                  ...
                  <h4
                    style={{
                      padding: "1em"
                    }}>to walkthrough through my work click</h4>
                  <a href="https://luckim21.github.io/artworks" className="button svelte-1s0lt5v">
                    here
                  </a>
                </div>
              </div>
