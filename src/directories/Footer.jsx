      ...
      <footer className="grid svelte-gfa3ns">
        <div className="fun svelte-gfa3ns">
          ...
          <div className="legal svelte-gfa3ns">
            <div className="svelte-gfa3ns">© 2024 Luckie Mumba</div>
            <div className="dot svelte-gfa3ns">•</div>
            <div className="svelte-gfa3ns">
              <div className="colophon svelte-gfa3ns">
                <span className="svelte-gfa3ns">Colophon</span>
              </div>
            </div>
          </div>
        </div>
        <ul className="list elsewheres svelte-gfa3ns">
          <li className="h6 svelte-gfa3ns">Elsewhere</li>
        ...
        <div className="hours svelte-co75ut">
          <div className="hour svelte-co75ut" role="button">
            <div className="line-holder svelte-co75ut">
              <div className="line svelte-co75ut fill"></div>
            </div>
          </div>
          <div className="hour svelte-co75ut" role="button">
            <div className="line-holder svelte-co75ut">
          ...
          <div className="hour svelte-co75ut active" role="button">
            ...
            <div className="line-holder svelte-co75ut">
              <div className="line svelte-co75ut active fill"></div>
            </div>
          </div>
          <div className="hour svelte-co75ut" role="button">
            <div className="line-holder svelte-co75ut">
              <div className="line svelte-co75ut"></div>
            </div>
          </div>
          <div className="hour svelte-co75ut" role="button">
            <div className="line-holder svelte-co75ut">
