...
function zv(e, t, n, l, r, i, a, o, c) {
  (Mn = !1), (Gl = null), Rv.apply(Tv, arguments);
}
function Mv(e, t, n, l, r, i, a, o, c) {
  if ((zv.apply(this, arguments), Mn)) {
    if (Mn) {
      var d = Gl;
      (Mn = !1), (Gl = null);
...
var zm = At && "documentMode" in document && 11 >= document.documentMode,
  Ds = null,
  Oi = null,
  On = null,
  _i = !1;
...
var Tn =
  ...
  Dm = new Set("cancel close invalid load scroll toggle".split(" ").concat(Tn));
function oc(e, t, n) {
...
function Pu(e, t, n, l) {
  (t.value = n), (t.getSnapshot = l), Tu(t) && zu(e);
}
function Ru(e, t, n) {
  return n(function () {
    Tu(t) && zu(e);
...
function Zm(e, t, n) {
  ...
  if (Wu(e)) Qu(t, r);
    ...
    (n = Cu(e, t, r, l)),
      n !== null && ((r = ze()), xt(n, e, l, r), Ku(n, t, l));
  }
}
function Wu(e) {
  var t = e.alternate;
  ...
  return (
    ...
    e !== null && !Oe
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~r),
        Tt(e, t, r))
      : (le && n && Oa(t), (t.flags |= 1), Te(e, t, l, r), t.child)
  );
}
  ...
  if (e !== null) {
    ...
    if (Gn(i, l) && e.ref === t.ref)
      if (((Oe = !1), (t.pendingProps = l = i), (e.lanes & r) !== 0))
        e.flags & 131072 && (Oe = !0);
      else return (t.lanes = e.lanes), Tt(e, t, r);
  }
  return $i(e, t, n, l, r);
}
function Gu(e, t, n) {
  ...
  return (
    ...
    e !== null && !Oe
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~r),
        Tt(e, t, r))
      : (le && l && Oa(t), (t.flags |= 1), Te(e, t, n, r), t.child)
  );
}
...
function ea(e, t, n, l, r, i) {
  $u(e, t);
  var a = (t.flags & 128) !== 0;
  if (!l && !a) return r && mc(t, n, !1), Tt(e, t, i);
...
function Lc(e, t, n, l, r) {
  return sn(), Ba(r), (t.flags |= 256), Te(e, t, n, l), t.child;
}
...
function to(e, t) {
  return (
    (t = Tr({ mode: "visible", children: t }, e.mode, 0, null)),
    (t.return = e),
    (e.child = t)
  );
}
...
function nf(e, t, n, l, r, i, a) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (l = hi(Error(C(422)))), zl(e, t, a, l))
      : t.memoizedState !== null
      ? ((t.child = e.child), (t.flags |= 128), null)
      : ((i = l.fallback),
        (r = t.mode),
        (l = Tr({ mode: "visible", children: l.children }, r, 0, null)),
        (i = ys(i, r, a, null)),
        (i.flags |= 2),
        (l.return = t),
        (i.return = t),
        ...
        (t.memoizedState = ta),
        i);
  if (!(t.mode & 1)) return zl(e, t, a, null);
  if (r.data === "$!") {
    if (((l = r.nextSibling && r.nextSibling.dataset), l)) var o = l.dgst;
    return (l = o), (i = Error(C(419))), (l = hi(i, l, void 0)), zl(e, t, a, l);
  }
  if (((o = (a & e.childLanes) !== 0), Oe || o)) {
    ...
    return ao(), (l = hi(Error(C(421)))), zl(e, t, a, l);
  }
  return r.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function sh(e, t, n) {
  var l = t.pendingProps,
    r = l.revealOrder,
    i = l.tail;
  if ((Te(e, t, l.children, n), (l = ae.current), l & 2))
    (l = (l & 1) | 2), (t.flags |= 128);
  else {
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = xs(qt.current)), Rl(t))) {
          ...
          switch (((l[Nt] = t), (l[tl] = i), (e = (t.mode & 1) !== 0), n)) {
            ...
            case "video":
            case "audio":
              for (r = 0; r < Tn.length; r++) ee(Tn[r], l);
              break;
            case "source":
              ee("error", l);
              break;
          ...
          e: {
            switch (((a = Ai(n, l)), n)) {
              ...
              case "video":
              case "audio":
                for (r = 0; r < Tn.length; r++) ee(Tn[r], e);
                r = l;
                break;
              case "source":
                ee("error", e), (r = l);
            ...
            for (i in o)
              if (o.hasOwnProperty(i)) {
                ...
                i === "style"
                  ...
                  ? ((c = c ? c.__html : void 0), c != null && Td(e, c))
                  : i === "children"
                  ? typeof c == "string"
                    ? (n !== "textarea" || c !== "") && Qn(e, c)
...
function cf(e, t) {
  ...
  for (Ui = { focusedElem: e, selectionRange: n }, sr = !1, T = t; T !== null; )
          ...
          for (T = r; T !== null; )
            (a = T),
              ...
              a.tag === 22 && a.memoizedState !== null
                ...
                ? ((c.return = a), (T = c))
                : Fc(r);
        for (; i !== null; ) (T = i), dh(i), (i = i.sibling);
        (T = r), (Ml = o), (Ie = d);
      }
      zc(e);
    } else
      r.subtreeFlags & 8772 && i !== null ? ((i.return = r), (T = i)) : zc(e);
  }
}
function zc(e) {
  for (; T !== null; ) {
        ...
        case 3:
          if (
            ...
            if (((r = e.suspendedLanes), (r & l) !== l)) {
              ze(), (e.pingedLanes |= e.suspendedLanes & r);
              break;
            }
    ...
    try {
      if (((it.transition = null), (X = 16 > e ? 16 : e), Yt === null))
        ...
        for (Y |= 4, T = e.current; T !== null; ) {
          ...
          if (i.subtreeFlags & 2064 && a !== null) (a.return = i), (T = a);
          else
            e: for (; T !== null; ) {
              if (((i = T), i.flags & 2048))
                switch (i.tag) {
        ...
        for (T = u; T !== null; ) {
          a = T;
          var p = a.child;
          if (a.subtreeFlags & 2064 && p !== null) (p.return = a), (T = p);
          else
            e: for (a = u; T !== null; ) {
              if (((o = T), o.flags & 2048))
                try {
  ...
  switch (((t.lanes = 0), t.tag)) {
      ...
      return (
        ...
        r.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            Zi(t, l, e, n),
            (t = ea(null, t, l, !0, i, n)))
          : ((t.tag = 0), le && i && Oa(t), Te(null, t, r, n), (t = t.child)),
        t
      );
    case 16:
      l = t.elementType;
    ...
    case 4:
      return (
        Ka(t, t.stateNode.containerInfo),
        (l = t.pendingProps),
        e === null ? (t.child = nn(t, null, l, n)) : Te(e, t, l, n),
        t.child
      );
    case 11:
      return (
...
function rp(e) {
    ...
    let g = e.hydrationData ? e.hydrationData.loaderData : null,
      ...
      q = (E) =>
        E.route.loader
          ...
          : !0;
    if (w) {
      let E = f.findIndex((z) => w[z.route.id] !== void 0);
  ...
  function We(g, w) {
    ...
    let q = [],
      E = [];
    h.v7_fetcherPersist &&
      x.fetchers.forEach((z, V) => {
        z.state === "idle" && (He.has(V) ? E.push(V) : q.push(V));
      }),
      [...m].forEach((z) =>
        z(x, {
          deletedFetchers: E,
      ...
      h.v7_fetcherPersist &&
        (q.forEach((z) => x.fetchers.delete(z)), E.forEach((z) => xl(z)));
  }
  function vn(g, w, q) {
    var E, z;
  ...
  async function hs(g, w, q) {
    ...
    let M = Ts(e.history, w, R.signal, q && q.submission),
      W;
    if (q && q.pendingError)
  ...
  function Wh(g, w, q, E) {
    ...
    b.has(g) && _t(g);
    let z = (E && E.unstable_flushSync) === !0,
      V = o || a,
      D = ma(
        x.location,
        x.matches,
      ...
      M = Ks(V, D, c);
    if (!M) {
      pn(g, w, tt(404, { pathname: D }), { flushSync: z });
      return;
    }
    let {
      path: W,
    ...
    dt.set(g, { routeId: w, path: W }), Kh(g, w, W, Ne, M, z, U);
  }
  async function Qh(g, w, q, E, z, V, D) {
    ...
    let W = new AbortController(),
      U = Ts(e.history, q, W.signal, D);
    b.set(g, W);
    let ye = O,
      _ = (await fn("action", U, [E], z))[0];
    if (U.signal.aborted) {
  ...
  async function Kh(g, w, q, E, z, V, D) {
    let M = x.fetchers.get(g);
    Ot(g, bn(D, M ? M.data : void 0), { flushSync: V });
    let W = new AbortController(),
      U = Ts(e.history, q, W.signal);
    b.set(g, W);
    let ye = O,
      _ = (await fn("loader", U, [E], z))[0];
    if (
  ...
  async function mn(g, w, q) {
    ...
    if (n) {
      ...
      if (w.response.headers.has("X-Remix-Reload-Document")) se = !0;
        ...
        se = xe.origin !== t.location.origin || zt(xe.pathname, c) == null;
      }
      if (se) {
  ...
  async function fn(g, w, q, E) {
    try {
      ...
      return q.map(() => ({ type: ne.error, error: z }));
    }
  }
  async function qo(g, w, q, E, z) {
    let [V, ...D] = await Promise.all([
      q.length ? fn("loader", z, q, w) : [],
      ...E.map((M) => {
        if (M.matches && M.match && M.controller) {
          let W = Ts(e.history, M.path, M.controller.signal);
  ...
  function pn(g, w, q, E) {
    E === void 0 && (E = {});
    let z = Hn(x.matches, w);
    xl(g),
      We(
        { errors: { [z.route.id]: q }, fetchers: new Map(x.fetchers) },
  ...
  function bo(g) {
    ...
    for (let [q, E] of Z)
      if (E < g) {
        let z = x.fetchers.get(q);
        H(z, "Expected fetcher: " + q),
          z.state === "loading" && (_t(q), Z.delete(q), w.push(q));
      }
...
function ma(e, t, n, l, r, i, a, o) {
  ...
  let h = po(r || ".", fo(c, i), zt(e.pathname, n) || e.pathname, o === "path");
  return (
...
function Fp() {
  ...
  let t = S.useContext(Ph),
    n = zp(Nr.UseRouteError),
    l = zh(Nr.UseRouteError);
  return t !== void 0 ? t : (e = n.errors) == null ? void 0 : e[l];
}
function Dp() {
  let { router: e } = Tp(Th.UseNavigateStable),
    t = zh(Nr.UseNavigateStable),
    n = S.useRef(!1);
  return (
    Rh(() => {
      n.current = !0;
...
function a1(e, t) {
  ...
  let i = zt(n.currentLocation.pathname, l) || n.currentLocation.pathname,
    a = zt(n.nextLocation.pathname, l) || n.nextLocation.pathname;
...
const Dh = "/website/assets/Avator-DH6d9pp6.jpg",
      ...
      children: [
        s.jsx("header", {
          ...
          children: s.jsx("nav", {
            className: "navbar",
            children: s.jsxs("ul", {
              className: "main navbar blur scrolled",
              children: [
                s.jsx("li", {
                  className: "navbar",
                  children: s.jsxs(Ln, {
  ...
  u1 = () =>
    s.jsx("div", {
      style: { justifyContent: "center", position: "fixed" },
      children: s.jsx("a", {
        href: "",
  ...
  h1 = () =>
    s.jsxs(s.Fragment, {
      children: [s.jsx(c1, {}), s.jsx(u1, {}), s.jsx(d1, {}), s.jsx(Op, {})],
    }),
  _r = () =>
    s.jsxs(s.Fragment, {
      children: [
  ...
  v1 = "/website/assets/ai-Cqhmxhpv.png",
  m1 = "/website/assets/figma-RjXCNYLM.png",
  f1 = "/website/assets/docs-CnzQDNUQ.png",
  p1 = "/website/assets/hs-DtLTeUqt.png",
  x1 = ({ color: e }) =>
    s.jsx("div", {
      children: s.jsx("svg", {
        fill: e,
  ...
  N1 = "/website/assets/doodler-CGsaiZ3Z.png",
  k1 = "/website/assets/hp-droplette-ybLVHmIu.png",
  q1 = () =>
    s.jsxs(s.Fragment, {
      children: [
        s.jsx("h2", {
  ...
  b1 = "/website/assets/large-07-CTFQrkr4.png",
  I1 = "/website/assets/small-03-BzkIeIt5.jpg",
  L1 = () =>
    s.jsxs(s.Fragment, {
      children: [
        s.jsx("div", {
  ...
  O1 = "/website/assets/icon-DL1Ez9re.png",
  _1 = () =>
    s.jsx(s.Fragment, {
      children: s.jsx("div", {
        children: s.jsx("div", {
  ...
  B1 = () =>
    s.jsxs(s.Fragment, {
      children: [s.jsx(T1, {}), s.jsx(_1, {}), s.jsx(_r, {})],
    }),
  U1 =
  ...
  X1 = () =>
    s.jsxs("div", { children: [s.jsx(V1, {}), s.jsx(Y1, {}), s.jsx(_r, {})] }),
  Z1 = () =>
    s.jsx(s.Fragment, {
      children: s.jsxs("main", {
        className: "svelte-1p8u9ev",
  ...
  G1 = () =>
    s.jsxs("div", {
      children: [
        s.jsx("h1", {
          className: "svelte-veednl tight",
          children: s.jsx("span", { slot: "title", children: "Hello" }),
        }),
        s.jsxs("div", {
          className: "wrapper svelte-fn0uxd",
          children: [
  ...
  lx = Kp(
    xa(
      s.jsxs(Qe, {
        ...
        element: s.jsx(h1, {}),
        children: [
          s.jsx(Qe, { index: !0, element: s.jsx(S1, {}) }),
          s.jsx(Qe, { path: "/Projects", element: s.jsx(X1, {}) }),
          s.jsx(Qe, { path: "/About", element: s.jsx(R1, {}) }),
          s.jsx(Qe, { path: "/Notes", element: s.jsx(B1, {}) }),
          s.jsx(Qe, { path: "/Login", element: s.jsx($1, {}) }),
          s.jsx(Qe, { path: "/WebProjects", element: s.jsx(Z1, {}) }),
          s.jsx(Qe, { path: "/Css", element: s.jsx(ex, {}) }),
          s.jsx(Qe, { path: "/Ai", element: s.jsx(tx, {}) }),
          s.jsx(Qe, { path: "/Architecture", element: s.jsx(sx, {}) }),
          s.jsx(Qe, { path: "/Throwaways", element: s.jsx(nx, {}) }),
          s.jsx(Qe, { path: "*", element: s.jsx(G1, {}) }),
        ],
      })
    )
  ),
  rx = () => s.jsx(s.Fragment, { children: s.jsx(t1, { router: lx }) });
wi.createRoot(document.getElementById("root")).render(
  s.jsx(jd.StrictMode, { children: s.jsx(rx, {}) })
);
